  ...
  return (
    <section className="relative w-full min-h-screen flex justify-center items-center overflow-hidden bg-[#090412] text-white pt-16 sm:pt-24 pb-10">
      ...
      <div className="relative z-20 max-w-7xl mx-auto w-full flex flex-col items-center gap-8 md:gap-4 px-2 py-12">
        {/* Badge */}
        <div
          className={`transition-all duration-700 ease-out flex justify-center items-center w-full ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
            }`}
        ...
        <div className="flex flex-col items-center justify-center  gap-4 mt-0 min-h-[120px] sm:min-h-[200px]  w-[13rem] sm:w-full">
          <div className="flex flex-col w-full justify-center items-center gap-10 sm:gap-2 sm:gap-2">
            <h2
              className={`hidden sm:block text-lg md:text-4xl lg:text-5xl text-center font-extrabold transition-all ease-out ${!headingFadeComplete
                  ? "scale-150 opacity-0"
            ...
            <h2
              className={`sm:hidden block text-lg md:text-4xl lg:text-5xl text-center font-extrabold transition-all ease-out ${!headingFadeComplete
                  ? "scale-150 opacity-0"
                  : "scale-150 opacity-100"
                } ${headingPositionComplete ? "translate-y-0" : "translate-y-[10vh]"}`}
              style={{
            ...
            <h2
              className={`hidden sm:block text-xl md:text-5xl lg:text-5xl text-center scale-150 leading-tight bg-gradient-to-r from-[#40ffaa] via-[#4079ff] to-[#40ffaa] bg-clip-text text-transparent transition-all duration-700 ease-out ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
                }`}
              style={{ willChange: "transform, opacity" }}
            >
              <GradientText
            ...
            <h2
              className={`block sm:hidden text-3xl md:text-5xl lg:text-5xl text-center scale-150 leading-tight  transition-all duration-700 ease-out ${bebas_neue.className} ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
                }`}
              style={{ willChange: "transform, opacity" }}
            >
              {text2}
        ...
        {/* Description */}
        <p
          className={`text-sm sm:text-[18px] font-medium mt-0 sm:mt-2 text-center max-w-6xl text-white/90 leading-relaxed transition-all duration-700 ease-out ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
            }`}
        ...
        {/* Buttons */}
        <div
          className={`flex flex-row justify-center items-center gap-3 sm:gap-5 mt-4 transition-all duration-700 ease-out ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
            }`}
        ...
        {/* Labels */}
        <div
          className={`w-full sm:hidden flex justify-center items-center gap-1 sm:gap-4 mt-12 transition-all duration-700 ease-out ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
            }`}
        ...
        <div
          className={`w-full hidden sm:flex justify-center items-center gap-1 sm:gap-4 mt-12 transition-all duration-700 ease-out ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
            }`}
          style={{ transitionDelay: "450ms", willChange: "transform, opacity" }}
        >
          {[
