...
function WhyChooseCodeNeptune() {
  ...
  return (
    <div className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 relative overflow-hidden">
      {/* Background Effects */}
            ...
            return (
              ...
              >
                ...
                <div className="mb-6 flex justify-center">
                  <div className={`w-24 h-24 rounded-2xl bg-gradient-to-br ${reason.gradient} flex items-center justify-center shadow-lg group-hover:shadow-2xl transition-shadow duration-300`}>
                    {index === 0 ? (
