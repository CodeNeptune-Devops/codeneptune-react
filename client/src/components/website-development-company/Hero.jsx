  ...
  return (
    <section className="relative w-full min-h-screen flex justify-center items-center overflow-hidden bg-[#090412] text-white pt-24 pb-10">
      ...
      <div className="relative z-20 max-w-7xl mx-auto flex flex-col items-center gap-3 px-4 py-12">
        ...
        >
          At Code Neptune, we don’t just build websites — we create digital experiences that drive growth. Our expert team blends custom design with smart development to deliver stunning, high-performance websites that turn visitors into loyal customers.
        </p>
