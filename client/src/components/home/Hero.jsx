    ...
    <section className="relative w-full min-h-screen flex justify-center items-center overflow-hidden bg-[#090412] text-white pt-16 sm:pt-24 pb-10">
      ...
      <div className="relative z-20 max-w-7xl mx-auto w-full flex flex-col items-center gap-3 px-2 py-12">
        ...
        >
          ...
          className="px-2 sm:px-6 py-3 rounded-full text-md sm:text-lg font-semibold bg-[#B8BBBF] text-[#0F1116] w-40 sm:w-52 hover:bg-white transition-colors cursor-pointer">
            Start Your Project
          </button>
