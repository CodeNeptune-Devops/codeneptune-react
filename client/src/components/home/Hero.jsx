  ...
  return (
    <section className="relative w-full min-h-screen flex justify-center items-center overflow-hidden bg-[#090412] text-white pt-24 pb-10">
      ...
      <div className="relative z-20 max-w-7xl mx-auto flex flex-col items-center gap-3 px-4 py-12">
        ...
        >
          As a leading website and mobile app development company, we craft
          intelligent, AI-driven digital products that transform ideas into
        ...
        {/* Labels */}
        <div
          className={`w-full flex justify-around items-center gap-5 mt-12 transition-all duration-700 ease-out ${
            isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
          }`}
        ...
        >
          {[
            ...
            <div
              key={index}
              className="flex flex-col items-start gap-2 transition-all duration-700 ease-out"
              style={{
                transitionDelay: `${450 + index * 100}ms`,
                willChange: "transform, opacity",
              }}
            >
              <Image src={item.icon} alt={item.text1} height={50} width={50} />
