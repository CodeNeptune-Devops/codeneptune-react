...
function SolutionsForAllBusinessNeed() {
    ...
    const solutions = [
        {
            ...
            description: "We develop product-selling websites and service-based booking systems."
        },
        {
            icon: LayoutDashboard,
            title: "Custom Platforms and Dashboards",
            description: "From learning platforms to internal portals, we create scalable systems."
        },
        {
            icon: Globe,
            title: "High-Performance Landing Pages",
            description: "Ideal for capturing leads or promoting services."
        }
    ];
...
export default SolutionsForAllBusinessNeed;